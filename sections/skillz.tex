...
\begin{itemize}
  ...
  \item \textbf{Programming languages:} Python (and Cython),
    ...
    IDL, C++, C, MATLAB, R, Javascript, NCL
  ...
  \item \textbf{Build tools/systems:} CMake (C, C++, and Fortran, for Linux, macOS,
    and Windows) and CTest; Python packaging and distribution with pip and conda,
    including several recipes on conda-forge; GNU Autotools

  \item \textbf{Software development tools/services:} Git (through GitHub,
    GitLab, Bitbucket, and Codeberg), Subversion, GNU Compiler Collection, Docker, grep,
  ...
  \item \textbf{Operating systems:} Linux (Ubuntu, Red Hat), macOS, Windows
