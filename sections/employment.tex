...
\begin{compactitem}[\itembullet]
  ...
  \item Co-Investigator on funded projects:
    ...
    \end{compactitem}
  \item
    Taught in \textit{Code to Communicate} an NSF-funded bilingual program in
    programming and science communication in the geosciences (2021).
  \item
    Taught in the \textit{Earth Surface Processes Institute} (ESPIn) summer
    school (2020-2021).
  \item
    Taught in the \textit{Research Experience for Community College Students}
    (RECCS) program at CU Boulder (2021).
  \item
    Taught \textit{Software Carpentry} workshops with customized content for
