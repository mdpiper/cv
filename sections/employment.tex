...
\begin{compactitem}[\itembullet]
  ...
  \item
    Co-maintainer of the \textit{Basic Model Interface} (BMI), a set of functions
    for querying, modifying, and running models. Co-developer of BMI language
    bindings in C, C++, Fortran, Java, and Python, as well as examples of using
    these bindings with these languages.
  \item
    Co-developer of the \textit{Python Modeling Toolkit} (PyMT), an
  ...
  \item
    Co-developer of the \textit{Babelizer}, an open source Python utility for
    wrapping models that expose a BMI, allowing them to be imported as Python
    packages.
  \item
    Lead developer of the \textit{CSDMS Ivy} course material on scientific software
    development for researchers in earth and planetary surface processes.
  \item
    Co-developer of the \textit{Web Modeling Tool} (WMT), a RESTful
    ...
    and SQLite.
  \item
    Developer of \textit{Dakotathon}, a scriptable Python interface to
    the Dakota iterative systems analysis toolkit.
  \item
    Developer of the \textit{Permafrost Benchmark System} (PBS), which
  ...
  \item
    Co-developer of the \textit{CSDMS Bakery}, a repository of Anaconda recipes
    for model components, tools, and core cyberinfrastructure.
  \item
    Developer of \textit{rpm\_tools} and \textit{rpm\_models} for building and
    installing CSDMS software on RPM-based Linux distributions.
  ...
  \item Instructor and curriculum developer for in-person and online workshops:
    \begin{compactitem}[\itembullet]
      ...
      \item
        ...
        program at CU Boulder (2020--present).
      \item
